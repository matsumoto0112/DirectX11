...
namespace {
Math::Matrix4x4 createViewIgnoreWorldOffset(const Math::Vector3& pos, const Math::Vector3& lookat, const Math::Vector3& up) {
...
FollowCamera::FollowCamera(const Graphics::PerspectiveCamera::Info& info, Utility::Transform* targetTransform)
    ...
    mLocalMatrix = createViewIgnoreWorldOffset(info.position, info.lookat, info.up);
...
void FollowCamera::render() {
    ...
    mView = Math::Matrix4x4::createView(
