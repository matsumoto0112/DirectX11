...
public:
    static constexpr DXGI_FORMAT DefaultTextureFormat = DXGI_FORMAT::DXGI_FORMAT_R24G8_TYPELESS; //!< デフォルトのフォーマット
    static constexpr DXGI_FORMAT DefaultDSVFormat = DXGI_FORMAT::DXGI_FORMAT_D24_UNORM_S8_UINT; //!< デフォルトのフォーマット
    /**
