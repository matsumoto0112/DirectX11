...
const std::string PixelShaderName::TEXTURE2D = "2D/Texture2D_PS";
const std::string PixelShaderName::MODEL = "Model/Model_PS";
const std::string PixelShaderName::MODEL_NOTEXTURE = "Model/Model_NoTexture_PS";
...
const std::string PixelShaderName::TEXTURE2D_INVERSION = "2D/Texture2D_Inversion_PS";
const std::string PixelShaderName::MODEL_SHADOW_DIFFUSE = "model/Model_Shadow_Diffuse_PS";
const std::string PixelShaderName::MODEL_SHADOW_COLOR = "model/Model_Shadow_Color_PS";
